...
if(!$mail->send()) {
  ...
  echo "<h2
	...
	\"><center><span>Aconteceu algum erro!</span><p>Você pode tentar denovo ou enviar direto para " . $email_envio . "!</p></center><h2>";
//	
	echo "<html style=\"background: #000;\"></html>";
	echo "<meta HTTP-EQUIV='Refresh' CONTENT='10;URL=" . $site_url . "'>";
  ...
  echo "<h2
	...
	font-weight: normal;
	color: #89bb50;
	\"><center><span>Formulário Enviado Com Sucesso</span><p>Em breve eu entro em contato com você. Abraços.  <button>Voltar</button></p></center><h2>";
